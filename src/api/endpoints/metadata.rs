...
mod tests {
    ...
    fn test_metadata_txs_by_label() {
        ...
        serde_json::from_value::<TxMetadataLabelJsonInner>(json_value).unwrap();
    }
    ...
    fn test_test_metadata_txs_labels() {
        ...
        serde_json::from_value::<TxMetadataLabelsInner>(json_value).unwrap();
    }
    ...
    fn test_metadata_txs_by_label_cbor() {
        ...
        serde_json::from_value::<TxMetadataLabelCborInner>(json_value).unwrap();
    }
}
