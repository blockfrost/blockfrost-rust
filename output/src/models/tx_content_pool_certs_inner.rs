...
pub struct TxContentPoolCertsInner {
    ...
    pub metadata: Option<Box<crate::models::TxContentPoolCertsInnerMetadata>>,
    #[serde(rename = "relays")]
    pub relays: Vec<crate::models::TxContentPoolCertsInnerRelaysInner>,
...
impl TxContentPoolCertsInner {
    pub fn new(cert_index: i32, pool_id: String, vrf_key: String, pledge: String, margin_cost: f32, fixed_cost: String, reward_account: String, owners: Vec<String>, metadata: Option<crate::models::TxContentPoolCertsInnerMetadata>, relays: Vec<crate::models::TxContentPoolCertsInnerRelaysInner>, active_epoch: i32) -> TxContentPoolCertsInner {
