...
pub struct UtilsTxsEvaluateUtxosPostRequestAdditionalUtxoSetInnerInner {
    ...
    pub address: String,
    #[serde(rename = "value")]
    pub value: Box<crate::models::UtilsTxsEvaluateUtxosPostRequestAdditionalUtxoSetInnerInnerAnyOf1Value>,
...
impl UtilsTxsEvaluateUtxosPostRequestAdditionalUtxoSetInnerInner {
    pub fn new(address: String, value: crate::models::UtilsTxsEvaluateUtxosPostRequestAdditionalUtxoSetInnerInnerAnyOf1Value) -> UtilsTxsEvaluateUtxosPostRequestAdditionalUtxoSetInnerInner {
