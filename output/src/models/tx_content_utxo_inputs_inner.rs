...
impl TxContentUtxoInputsInner {
    pub fn new(address: String, amount: Vec<crate::models::TxContentOutputAmountInner>, tx_hash: String, output_index: i32, data_hash: Option<String>, inline_datum: Option<String>, reference_script_hash: Option<String>, collateral: bool) -> TxContentUtxoInputsInner {
