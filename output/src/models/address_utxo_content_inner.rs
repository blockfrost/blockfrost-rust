...
pub struct AddressUtxoContentInner {
    ...
    #[serde(rename = "amount")]
    pub amount: Vec<crate::models::TxContentOutputAmountInner>,
...
impl AddressUtxoContentInner {
    pub fn new(address: String, tx_hash: String, tx_index: i32, output_index: i32, amount: Vec<crate::models::TxContentOutputAmountInner>, block: String, data_hash: Option<String>, inline_datum: Option<String>, reference_script_hash: Option<String>) -> AddressUtxoContentInner {
