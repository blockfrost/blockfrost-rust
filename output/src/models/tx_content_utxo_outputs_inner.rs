...
impl TxContentUtxoOutputsInner {
    pub fn new(address: String, amount: Vec<crate::models::TxContentOutputAmountInner>, output_index: i32, data_hash: Option<String>, inline_datum: Option<String>, collateral: bool, reference_script_hash: Option<String>) -> TxContentUtxoOutputsInner {
