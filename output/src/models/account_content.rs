...
impl AccountContent {
    pub fn new(stake_address: String, active: bool, active_epoch: Option<i32>, controlled_amount: String, rewards_sum: String, withdrawals_sum: String, reserves_sum: String, treasury_sum: String, withdrawable_amount: String, pool_id: Option<String>) -> AccountContent {
        AccountContent {
            stake_address,
            active,
            active_epoch,
