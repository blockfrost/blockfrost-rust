...
pub struct AddressContentExtended {
    ...
    pub address: String,
    #[serde(rename = "amount")]
    pub amount: Vec<crate::models::AddressContentExtendedAmountInner>,
...
impl AddressContentExtended {
    pub fn new(address: String, amount: Vec<crate::models::AddressContentExtendedAmountInner>, stake_address: Option<String>, r#type: RHashType, script: bool) -> AddressContentExtended {
