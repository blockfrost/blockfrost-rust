...
pub struct Asset {
    ...
    pub metadata: Option<Box<crate::models::AssetMetadata>>,
}

impl Asset {
    pub fn new(asset: String, policy_id: String, asset_name: Option<String>, fingerprint: String, quantity: String, initial_mint_tx_hash: String, mint_or_burn_count: i32, onchain_metadata: Option<::std::collections::HashMap<String, serde_json::Value>>, metadata: Option<crate::models::AssetMetadata>) -> Asset {
        Asset {
            asset,
            policy_id,
            asset_name,
